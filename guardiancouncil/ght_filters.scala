...
// I/Os
//==========================================================
class GHT_FILTERS_IO (params: GHT_FILTERS_Params) extends Bundle {
  ...
  val effective_memaddr                         = Input(Vec(params.core_width, UInt(params.xlen.W)))
...
trait HasGHT_FILTERS_IO extends BaseModule {
  val params: GHT_FILTERS_Params
  val io = IO(new GHT_FILTERS_IO(params))
}

//==========================================================
// Implementations
//==========================================================
class GHT_FILTERS (val params: GHT_FILTERS_Params) extends Module with HasGHT_FILTERS_IO
{
  ...
  for (i <- 0 to params.core_width - 1) {
    ...
    u_ght_filters(i).io.jalr_target            := this.io.jalr_target(i)
    u_ght_filters(i).io.effective_memaddr      := this.io.effective_memaddr(i)
